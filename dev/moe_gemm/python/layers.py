...
USE_GEMV_OPTIM = int(os.getenv("USE_GEMV_OPTIM", "1"))

try:
    BLOCK_CONFIG = json.load(open(Path(__file__) / "block_config.json"))
except:
    BLOCK_CONFIG = {}
    logger.warning("NO BLOCK CONFIG FIND! ")
