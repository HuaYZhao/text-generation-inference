...
void allreduce(torch::Tensor tensor, NcclParam *nccl_param_ptr)
{
...
void allgather_into_tensor(torch::Tensor recv_tensor, torch::Tensor send_tensor, NcclParam *nccl_param_ptr)
{
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m)
{
    ...
    m.def("allgather_into_tensor", &allgather_into_tensor, "");
}